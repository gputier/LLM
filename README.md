...
| ----------------------------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [llm-station-cuda](https://github.com/gputier/llm-station-cuda)         | RTX 5090, 32 GB, plus a second box on an RTX 4080 SUPER, 16 GB | CUDA, nine builds, two of them forks and two compiled here; the 16 GB box runs the BeeLlama fork plus one release | Nineteen profiles, all at a 262,144 window with their authors' sampling since 2026-09-26: Tiel-Coder and KAT-Coder 35B-A3B, Muse Glimmer 30B, Qwen3.8-27B NVFP4 and three fine-tunes (abliterated, TurboFCFusion, Twin-Turbo 709-L), Ornith 1.5 9B, Nex-N2.5-mini, Spark-X2.5-4B, both Ternary Bonsai generations, Hemmingway-1, VeriLoop-E2, Xing 4.0 on its pull-request engine, three APEX requantisations (Qwen3.6, KAT-Coder, Occamy), and an embedder. Whittle was rejected on 2026-09-19. The 16 GB box serves `tiel`, `qwen36` and lighter builds of the three APEX models |
